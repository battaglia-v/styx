...
object FakeHttpServer {
  ...
  class HttpsStartupConfig(val httpsPort: Int = 0,
                           val adminPort: Int = 0,
  ...
  class HttpStartupConfig(val port: Int = 0,
                          val appId: String = "generic-app",
    ...
    fun start(): FakeHttpServer {
      ...
      val server = FakeHttpServer.newHttpServer(appId, originId, this.asJava()).start()
