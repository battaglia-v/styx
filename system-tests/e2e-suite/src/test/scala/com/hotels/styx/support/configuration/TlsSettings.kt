...
class Certificate(val alias: String, val certificatePath: String) {
  ...
  companion object {
    fun fromJava(from: Certificate): com.hotels.styx.support.configuration.Certificate =
      Certificate(from.alias, from.certificatePath)
  }
}
...
class TlsSettings(
  ...
  companion object {
    ...
    fun fromJava(from: com.hotels.styx.api.extension.service.TlsSettings): TlsSettings =
      TlsSettings(
