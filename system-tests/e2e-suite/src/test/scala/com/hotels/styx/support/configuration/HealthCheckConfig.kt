...
data class HealthCheckConfig(
    ...
    fun asJava(): com.hotels.styx.api.extension.service.HealthCheckConfig = com.hotels.styx.api.extension.service.HealthCheckConfig.newHealthCheckConfigBuilder()
        .uri(uri)
    ...
    companion object {
      fun fromJava(from: com.hotels.styx.api.extension.service.HealthCheckConfig): HealthCheckConfig =
        HealthCheckConfig(
