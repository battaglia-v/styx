...
object StyxServerSupport {
  ...
  fun newHttpsConnConfig(port: Int): HttpsConnectorConfig = HttpsConnectorConfig.Builder()
    .sslProvider("JDK")
    .port(port)
    .build()
  ...
  fun newProxyServerConfigBuilder(httpConnConfig: HttpConnectorConfig, httpsConnConfig: HttpsConnectorConfig) = {
    ProxyServerConfig.Builder()
      .setConnectors(Connectors(httpConnConfig, httpsConnConfig))
  }

  fun newStyxConfig(yaml: String, proxyServerConfigBuilder: ProxyServerConfig.Builder, adminServerConfigBuilder: AdminServerConfig.Builder) =
...
interface StyxServerSupplements {
  ...
  fun routerURL(path: String) = "http://${httpsProxyHost()}$path"
