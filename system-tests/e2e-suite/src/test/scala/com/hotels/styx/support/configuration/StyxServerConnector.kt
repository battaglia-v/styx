...
interface StyxServerConnector

class HttpConnectorConfig(val port: Int = 0) : StyxServerConnector {
  fun asJava(): com.hotels.styx.server.HttpConnectorConfig = com.hotels.styx.server.HttpConnectorConfig(port)
}

class HttpsConnectorConfig( val port: Int = 0,
                            ...
                            val protocols: List<String> = defaultHttpsConfig.protocols()
                            ) : StyxServerConnector {

  fun asJava(): com.hotels.styx.server.HttpsConnectorConfig = com.hotels.styx.server.HttpsConnectorConfig.Builder()
    .port(port)
...
companion object {
    ...
    fun selfSigned(httpsPort: Int): HttpsConnectorConfig =
